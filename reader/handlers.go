...
func NewTopicHandler[T any, P any](
	...
	retrieveTopicAndObject func(T, systemge.Connection[T]) (string, P, error), // returns topic and O since returning topic and T would be inefficient in most scenarios
) systemge.ReadHandlerWithError[T] {

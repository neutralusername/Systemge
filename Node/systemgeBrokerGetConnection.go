...
func (systemge *systemgeComponent) resolutionSafetyMechanism(topic string) (*brokerConnection, error) {
...
func (node *Node) getBrokerConnectionForTopic(topic string, addTopicResolution bool) (*brokerConnection, error) {
	...
	brokerConnection, err := systemge.resolutionSafetyMechanism(topic)
	if err != nil {
		return nil, err
	}
	if brokerConnection != nil {

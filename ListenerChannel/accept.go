...
func (listener *ChannelListener[T]) Accept(timeoutNs int64) (Systemge.SystemgeConnection[T], error) {
...
func (listener *ChannelListener[T]) accept(cancel <-chan struct{}) (Systemge.SystemgeConnection[T], error) {
	select {

...
type ConnectionAttempt struct {
	...
	systemgeConnection SystemgeConnection.SystemgeConnection[[]byte]
...
func (connectionAttempt *ConnectionAttempt) GetResultBlocking() SystemgeConnection.SystemgeConnection[[]byte] {

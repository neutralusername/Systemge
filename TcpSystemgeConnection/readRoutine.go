...
func (client *TcpSystemgeConnection) StartReadRoutine(maxConcurrentHandlers uint32, delayNs int64, timeoutNs int64, readHandler Tools.ReadHandler[*WebsocketClient]) error {

...
func (server *Server) handleClientMessages(client *ClientConnection) {
...
func (server *Server) handleMessage(client *ClientConnection, message *Message.Message) error {
...
func (server *Server) handleSyncRequest(client *ClientConnection, message *Message.Message) error {
	server.mutex.Lock()
